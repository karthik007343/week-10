    ...
    public Registration() {
        ...
        submit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
               	if(nameT.getText().toString().isEmpty()||emailT.getText().toString().isEmpty()||mobileT.getText().toString().isEmpty()||regnoT.getText().toString().isEmpty()||branch.getSelectedItem().toString().isEmpty()){
